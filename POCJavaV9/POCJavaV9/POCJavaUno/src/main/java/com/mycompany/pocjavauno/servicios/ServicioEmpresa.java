...
public class ServicioEmpresa {
    ...
    public static final String NOM_ARCHIVO = "data//empresa.txt";
    public static final int TAM_NOMBRE = 20;
    public static final int TAM_REGISTRO = 26;
    ...
    public static Empresa buscarEmpresa(int pNit){
        String nombre;
        int nit;
        Empresa emp = null;
    ...
    public static boolean guardarEnArchivo(Empresa emp){
        
        Empresa buscado = buscarEmpresa(emp.getNit());
