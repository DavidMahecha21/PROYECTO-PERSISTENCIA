 ...
 * @author Unibague
 */
public class GUIParcial extends javax.swing.JFrame {

    /**
     * Creates new form GUIParcial
     */
    public GUIParcial() {
        initComponents();
    ...
    private void btnParcialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnParcialActionPerformed
        ...
        ServicioEmpleado.actualizarEmpleadoParcial(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIParcial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIParcial().setVisible(true);
            }
        });
    }
